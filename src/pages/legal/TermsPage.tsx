  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        >
          <h1 className="text-4xl font-serif font-bold text-gradient mb-2">Terms of Service</h1>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-foreground mb-4">4. Medical Disclaimer</h2>
