  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 sm:px-6 py-6 sm:py-8 md:py-12 max-w-4xl">
        ...
        >
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-serif font-bold text-gradient mb-1 sm:mb-2">Refund Policy</h1>
          <p className="text-muted-foreground text-sm sm:text-base mb-6 sm:mb-8">Last updated: January 15, 2024</p>

          <section className="mb-6 sm:mb-8">
            <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3 sm:mb-4">Our Policy</h2>
            <div className="bg-coral/10 border border-coral/30 rounded-lg p-3 sm:p-4 mb-3 sm:mb-4">
              <p className="text-foreground font-medium mb-2 text-sm sm:text-base">No Refunds for Active Subscriptions</p>
          ...
          <section className="mb-6 sm:mb-8">
            <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3 sm:mb-4">Free Trial</h2>
            <div className="bg-lavender/10 border border-lavender/30 rounded-lg p-3 sm:p-4 mb-3 sm:mb-4">
              <p className="text-foreground font-medium mb-2 text-sm sm:text-base">14-Day Free Trial</p>
              <p className="text-muted-foreground text-sm sm:text-base">
          ...
          <section className="mb-6 sm:mb-8">
            <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3 sm:mb-4">Exception: Major Issues</h2>
          ...
          <section className="mb-6 sm:mb-8">
            <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3 sm:mb-4">How to Request a Refund</h2>
            <p className="text-muted-foreground text-sm sm:text-base mb-3 sm:mb-4">
              If you believe you qualify for a refund due to a major issue:
            </p>
            <ol className="list-decimal pl-5 sm:pl-6 text-muted-foreground text-sm sm:text-base space-y-2 sm:space-y-3">
              <li>
          ...
          <section className="mb-6 sm:mb-8">
            <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3 sm:mb-4">Refund Processing</h2>
            <p className="text-muted-foreground text-sm sm:text-base mb-3 sm:mb-4">
          ...
          <section className="mb-6 sm:mb-8">
            <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3 sm:mb-4">Non-Refundable Situations</h2>
            <p className="text-muted-foreground text-sm sm:text-base mb-3 sm:mb-4">
          ...
          <section className="mb-6 sm:mb-8">
            <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3 sm:mb-4">Cancellation vs. Refund</h2>
            <div className="bg-secondary/50 rounded-lg p-3 sm:p-4">
              <p className="text-foreground font-medium mb-2 text-sm sm:text-base">Important Distinction:</p>
          ...
          <section className="mb-6 sm:mb-8">
            ...
            <div className="bg-secondary/50 rounded-lg p-3 sm:p-4">
              <p className="text-foreground text-sm sm:text-base">Email: <a href="mailto:support@afiiia.com" className="text-primary hover:underline">support@afiiia.com</a></p>
              <p className="text-foreground text-sm sm:text-base mt-2">Response time: Within 24-48 hours</p>
            </div>
          </section>
        </motion.div>
      </main>
