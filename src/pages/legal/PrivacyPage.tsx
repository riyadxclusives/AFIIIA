  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        >
          <h1 className="text-4xl font-serif font-bold text-gradient mb-2">Privacy Policy</h1>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-4">We may share your information only in these circumstances:</p>
            <ul className="list-disc pl-6 text-muted-foreground space-y-2">
          ...
          <section className="mb-8">
            ...
            <div className="bg-secondary/50 rounded-lg p-4">
              <p className="text-foreground">Email: <a href="mailto:privacy@afiiia.com" className="text-primary hover:underline">privacy@afiiia.com</a></p>
              <p className="text-foreground mt-2">Data Protection Officer: <a href="mailto:dpo@afiiia.com" className="text-primary hover:underline">dpo@afiiia.com</a></p>
            </div>
          </section>
        </motion.div>
      </main>
